...
HUGE_CSV = 'Special Run Bogus.csv'
...
def five_month_survey_log_time():

    logs = li.CSVLogIterator(datetime.datetime(2014, 4, 15), datetime.datetime(2014, 9, 15))
    logs.find_all_logs_survey()
    all_year_months = logs.log_files_to_use
...
all_years_months = five_month_survey_log_time()
